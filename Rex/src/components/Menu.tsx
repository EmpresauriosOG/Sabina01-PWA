...
export default function Menu() {
  ...
  const handleChatSend = async () => {
    ...
    try {
      const response = await axios.post(
        `https:///menu/rag/665239a9f25b93e429b870bc/66523d74f25b93e429b870be/1/${chatInput}`
      );
  ...
  return (
    <div className="py-7 px-14 relative bg-gray-900 min-h-screen">
      ...
      <div
        className="fixed top-4 right-4 bg-gray-900 min-h-screen text-white p-3 rounded-full cursor-pointer shadow-lg hover:bg-blue-600 transition-colors z-50"
                  ...
                  <div className="flex-grow">
                    ...
                    <div className="flex items-center mt-1">
                      <Button
                        ...
                        onClick={() =>
                          updateOrderQuantity(item.name, item.quantity - 1)
                        }
                      >
            ...
            {filteredMenuItems.map((item) => (
              <Card key={item._id} className="bg-gray-800 text-white">
                ...
                <CardContent>
                  ...
                  <p className="font-bold mt-2 text-blue-400">
                  ...
                  <Drawer>
                    ...
                    <DrawerContent>
                      ...
                      <DrawerFooter>
                        ...
                        <Button onClick={() => addToOrderWithAmount(item)}>
                          Add To Order
                        </Button>
                        <DrawerClose>
