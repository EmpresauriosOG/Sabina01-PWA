      ...
      <Card className="flex flex-col justify-center items-center border">
        <CardHeader>
          ...
          <CardDescription className="w-80">
            Welcome to our restaurant! If you have already been seated, we hope
            you enjoy your dining experience. If you are still awaiting a table,
            please feel free to browse our menu at your leisure.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      This is the display name for your bill.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col items-center">
                    ...
                    <FormDescription>
                      Enter the table code provided by your waiter.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
